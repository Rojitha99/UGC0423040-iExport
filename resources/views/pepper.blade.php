...
<!-- Main Navbar - Fixed -->
<nav class="navbar navbar-expand-lg navbar-dark py-3 fixed-navbar main-navbar" style="background-color:#3B3B3B">
...
<div class="container-fluid py-3 fixed-navbar secondary-navbar" style="background-color:#3B3B3B">
  <div class="container">
      ...
      <ul class="navbar-nav d-flex flex-row flex-wrap justify-content-center gap-3">
        ...
        <li class="nav-item dropdown">
          <a class="nav-button dropdown-toggle" href="product.html" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <li><a class="dropdown-item" href="{{ route('pepper') }}" style="background-color: #c58911">Ceylon Pepper </a></li>
    ...
    <div class="col-md-9">
      ...
      <div class="row" id="productsContainer">
        ...
        <div class="col-sm-6 col-lg-4 mb-4" 
          ...
          <a href="cin01.html" class="text-decoration-none text-dark">
            <div class="card h-100">
              <img src="{{ asset('images/pep.webp') }}" class="card-img-top" alt="Pineapple Plants">
              <div class="card-body">
        ...
        <div class="col-sm-6 col-lg-4 mb-4" 
          ...
          <a href="cin01.html" class="text-decoration-none text-dark">
            <div class="card h-100">
              <img src="{{ asset('images/pep5.webp') }}" class="card-img-top" alt="Pineapple Plants">
              <div class="card-body">
        ...
        <div class="col-sm-6 col-lg-4 mb-4" 
          ...
          <a href="cin01.html" class="text-decoration-none text-dark">
            <div class="card h-100" >
              <img src="{{ asset('images/pep6.webp') }}" class="card-img-top" alt="Pineapple Plants">
              <div class="card-body">
        ...
        <div class="col-sm-6 col-lg-4 mb-4" 
          ...
          <a href="#" class="text-decoration-none text-dark">
            <div class="card h-100">
              <img src="{{ asset('images/pep4.webp') }}" class="card-img-top" alt="Snake Plants">
              <div class="card-body">
        ...
        <div class="col-sm-6 col-lg-4 mb-4" 
          ...
          <a href="#" class="text-decoration-none text-dark">
            <div class="card h-100">
              <img src="{{ asset('images/pep3.webp') }}" class="card-img-top" alt="Snake Plants">
              <div class="card-body">
        ...
        <div class="col-sm-6 col-lg-4 mb-4" 
          ...
          <a href="#" class="text-decoration-none text-dark">
            <div class="card h-100">
              <img src="{{ asset('images/pep2.webp') }}" class="card-img-top" alt="Snake Plants">
              <div class="card-body">
