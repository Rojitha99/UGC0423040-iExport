...
<!-- Main Navbar - Fixed -->
<nav class="navbar navbar-expand-lg navbar-dark py-3 fixed-navbar main-navbar" style="background-color:#5E3023">
...
<div class="container-fluid py-3 fixed-navbar secondary-navbar" style="background-color:#5E3023">
  <div class="container">
      ...
      <ul class="navbar-nav d-flex flex-row flex-wrap justify-content-center gap-3">
        ...
        <li class="nav-item dropdown">
          <a class="nav-button dropdown-toggle" href="product.html" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <li><a class="dropdown-item" href="{{ route('cloves') }}" style="background-color: #c58911">Ceylon Cloves</a></li>
    ...
    <div class="col-md-9">
      ...
      <div class="row" id="productsContainer">
        ...
        <div class="col-sm-6 col-lg-4 mb-4" 
             ...
             data-price="20">
          <a href="{{ route('clo01') }}" class="text-decoration-none text-dark">
            <div class="card h-100">
