...
<div class="spice-nav">
    ...
    <div class="spice-item">
      ...
      <img src="nut.jpeg" style="filter: brightness(50%)" alt="Nutmeg">
      <div class="spice-name" style="opacity: 1">Ceylon Nutmeg</div></a>
    </div>
    <div class="spice-item">
    ...
    <div class="col-md-9">
      ...
      <div class="row" id="productsContainer">
        ...
        <div class="col-sm-6 col-lg-4 mb-4" 
          ...
          <a href="cin01.html" class="text-decoration-none text-dark">
            <div class="card h-100">
              <img src="nut.jpeg" class="card-img-top" alt="Pineapple Plants">
              <div class="card-body">
        ...
        <div class="col-sm-6 col-lg-4 mb-4" 
          ...
          <a href="cin01.html" class="text-decoration-none text-dark">
            <div class="card h-100" >
              <img src="nut2.webp" class="card-img-top" alt="Pineapple Plants">
              <div class="card-body">
        ...
        <div class="col-sm-6 col-lg-4 mb-4" 
          ...
          <a href="nut3.webp" class="text-decoration-none text-dark">
            <div class="card h-100" >
              <img src="nut3.webp" class="card-img-top" alt="Pineapple Plants">
              <div class="card-body">
        ...
        <div class="col-sm-6 col-lg-4 mb-4" 
          ...
          <a href="#" class="text-decoration-none text-dark">
            <div class="card h-100">
              <img src="nut4.webp" class="card-img-top" alt="Snake Plants">
              <div class="card-body">
        ...
        <div class="col-sm-6 col-lg-4 mb-4" 
          ...
          <a href="#" class="text-decoration-none text-dark">
            <div class="card h-100">
              <img src="nut5.webp" class="card-img-top" alt="Snake Plants">
              <div class="card-body">
        ...
        <div class="col-sm-6 col-lg-4 mb-4" 
          ...
          <a href="#" class="text-decoration-none text-dark">
            <div class="card h-100">
              <img src="nut6.webp" class="card-img-top" alt="Snake Plants">
              <div class="card-body">
