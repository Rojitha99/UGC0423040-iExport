    ...
    <div class="col-md-8">
      ...
      <div class="card h-100 text-center mb-4">
        ...
        <div class="d-flex justify-content-center gap-2 p-3">
          <img src="clo.jpeg" class="img-thumbnail border border-success thumb" alt="Thumb 1" width="80" onclick="changeImage(this)">
          <img src="clo2.webp" class="img-thumbnail thumb" alt="Thumb 2" width="80" onclick="changeImage(this)">
          <img src="clo3" class="img-thumbnail thumb" alt="Thumb 3" width="80" onclick="changeImage(this)">
        </div>
