...
<!-- Main Navbar - Fixed -->
<nav class="navbar navbar-expand-lg navbar-dark py-3 fixed-navbar main-navbar" style="background-color: #A0522D;">
  <div class="container-fluid">
    <a class="navbar-brand fw-bold fs-2" href="#"><i class="fa-solid fa-anchor"></i>
      iExport
    </a>
    ...
    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarContent" aria-controls="navbarContent" aria-expanded="false" aria-label="Toggle navigation">
      ...
      <ul class="navbar-nav navbar-nav-right mb-2 mb-lg-0 fs-5">
        <li class="nav-item me-3">
          <span class="text-white"><i class="bi bi-chat-left-dots"></i> Chat</span>
        </li>
        <li class="nav-item me-3">
          <span class="text-white"><i class="bi bi-person"></i> Login</span>
        </li>
        <li class="nav-item">
          <button class="btn btn-warning fw-bold post-ad-btn">POST YOUR AD</button>
        </li>
      </ul>
    </div>
  </div>
...
<div class="container-fluid py-3 fixed-navbar secondary-navbar" style="background-color:#A0522D ;">
  <div class="container">
    <div class="navbar justify-content-center">
      <ul class="navbar-nav d-flex flex-row flex-wrap justify-content-center gap-3">
        ...
        <li class="nav-item dropdown">
          <a class="nav-button dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            Product
          </a>
    ...
    <div class="col-md-8">
      ...
      <div class="card h-100 text-center mb-4">
        ...
        <div class="d-flex justify-content-center gap-2 p-3">
          <img src="nut.jpeg" class="img-thumbnail border border-success thumb" alt="Thumb 1" width="80" onclick="changeImage(this)">
          <img src="nut.webp" class="img-thumbnail thumb" alt="Thumb 2" width="80" onclick="changeImage(this)">
          <img src="nut2.webp" class="img-thumbnail thumb" alt="Thumb 3" width="80" onclick="changeImage(this)">
        </div>
        ...
        <p class="card-text" id="descriptionText">
            අන්නාසි වගාවක් ආරම්භ කර ඔබත් ඉහල ආදායමක් ලබා ගන්න.<br>
            <span id="dots">...</span>
            <span id="moreText" style="display: none;">
            නීරෝගී අන්නාසි පැල අපෙන් ලබා ගත හැක. ඉතා සාධාරණ මිලකට ලංකාවේ ඕනෑම තැනක සිටුවිය හැක.
            </span>
        </p>
